...
.DESCRIPTION
  ...
  under prompts, schemas, examples, helpers, scripts, evals, docs, skills, templates, and tests must
...
try {
    ...
    $relativeRoots = @("prompts", "schemas", "examples", "helpers", "scripts", "evals", "docs", "skills", "templates", "tests")
