...
6. Compile an execution contract before any execution layer acts.
7. Pause and recalibrate if new information changes the goal, boundary, risk, or validation path.
